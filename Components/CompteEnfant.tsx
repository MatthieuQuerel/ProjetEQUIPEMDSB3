...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    paddingTop: 250, // Ajoute de la marge en haut pour le bouton
    justifyContent: 'flex-start', // Aligne le contenu au début
    alignItems: 'center',
  },
  iconButton: {
    position: 'absolute',
    top: 40, // Positionne le bouton à 10 unités du haut
    left: 10, // Positionne le bouton à 10 unités de la gauche
    padding: 10,
  },
  icon: {
    marginRight: 350,
